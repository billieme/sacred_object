...
<?php
if(!isset($_SESSION['user_level'])== "a"){
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css"> <!--CSS Data Table-->
        <link rel="stylesheet" href="https://cdn.datatables.net/1.10.23/css/dataTables.bootstrap5.min.css"> <!--CSS Data Table-->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.css"> <!--Sweet Alert-->
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark d-flex justify-content-center pr-0">
            ...
            <button class="btn btn-link btn-sm order-1 order-lg-0 text-decoration-none bg-success text-light" id="sidebarToggle" href="#"><i class="fas fa-bars"></i> ย่อและขยายแถบเมนู</button>
            </div>
            <!-- Navbar Search-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="container">
                                        ...
                                        <p class="text-center m-0 p-0"><i class="fas fa-circle text-success"></i> ยินดีต้อนรับ, คุณ : </p><p class="text-center  m-0 mb-2 p-0">[ <?php echo $_SESSION['name']." ".$_SESSION['lname']; ?> ]</p>
                                            <a href="../chk_all/chk_logout.php?logout=m"><button class="btn btn-danger w-100 border border-light">ออกจากระบบ <i class="fas fa-door-open"></i></button></a>
                                        </div>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert-dev.js"></script> <!-- Sweet alert-->
