...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark d-flex justify-content-center pr-0">
        <p class="navbar-brand text-light">ผู้ดูแลระบบ </p>
                    ...
                    <div class="nav">
                        <div class="container">
                            ...
                            <ul id="ul_m">
                                ...
                                <a href="super_admin.php?m=1" class="text-light">
                                    <li>
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col">
                                                <p class="mb-0" id="t_m_m1">กำหนดสิทธิ์ในการเข้าใช้งาน</p>
                                            </div>
                                        </div>
                                    </li>
                                </a>
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                switch ($_GET['m']){
                    ...
                    break;
                    case 1:
                        include_once('include_for_sup/mange_sys.php');
                    break;
                    case 2:
                        include_once('include_for_sup/edit_user.php');
                    break;
