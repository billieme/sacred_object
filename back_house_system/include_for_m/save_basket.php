                    ...
                    <div class="w-100 alert alert-success">
                        ...
                        <table class="w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="id4basket[]" id=""
                                            value="<?php echo $num['id_basket'] ;?>" hidden="true">
                        ...
                        <table class="">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="pt-2">
                                        <input type="text" class="ml-2 form-control" name="name_cus" required>
                                    </td>
                                </tr>
                                <tr>
