                    ...
                    <div class="card-body pt-4">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div><p class="d-inline text-secondary font-weight-light" style="font-size:0.9rem;">ผู้เขียนข่าวโดย คุณ, <?php echo $num['news_author']; ?> > โพสต์เมื่อ : <?php echo $newsAll->thai_date_and_time(strtotime($time = $num['date_create'])); ?></p> </div>
