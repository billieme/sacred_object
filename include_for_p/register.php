    ...
    <div class="container">
        <div class="card mt-4 mb-4">
            <div class="card-header text-center bg-dark">
                <h3 class="mb-2 text-white"><b><i class="fas fa-user-plus text-success"></i> ระบบสมัครสมาชิก Registration system</b></h3>
            </div>
                    ...
                    <form action="chk_all/check_reg.php" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-lg-6">
                                ...
                                <input id="user" style="width:100%;" type="text" class="form-control border border-secondary" name="username" required>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input style="width:100%;" type="text" class="form-control border border-secondary" name="password" required>
                        ...
                        <div class="form-group">
                            ...
                            <select style="width:100px;" class="form-control border border-secondary" id="exampleFormControlSelect1" name="title_name" required>
                                <option>นาย</option>
                                <option>นาง</option>
                        ...
                        <div class="form-row">
                            <div class="col-lg-5">
                                ...
                                <input style="width:100%;" type="text" class="form-control border border-secondary" name="first_name" required>
                            </div>
                        
                            <div class="col-lg-5">
                                <label for="last_name" class="mt-2"> <b>นามสกุล</b></label>
                                <input style="width:100%; "type="text" class="form-control border border-secondary" name="last_name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-lg-5">
                                ...
                                <input style="width:150%;" type="email" class="form-control border border-secondary" name="email" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input style="width:200px;" type="text" class="form-control border border-secondary" name="phone_number" required maxlength="10">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label w-100 border border-secondary " for="customFile">Choose file</label>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-4 mb-4">
                            <div class="col d-flex justify-content-end">
                                <input id="btnCancel" type="reset" class="btn btn-warning mr-2 text-light"  name="reset" value="ยกเลิก">
