...
<head>
    ...
    <link rel="stylesheet" href="css/myself.css"><!--CSS หน้าแรก-->
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> <!-- font awesome4 -->
    <link rel="stylesheet" href="bootstrap/bootstrap.css"> <!--bootstrap-->
    



    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css"> <!--CSS Data Table-->
...
<body>
                                        ...
                                        <div class="col-sm d-flex justify-content-end">
                                            <form action="chk_all/check_login.php" method="post">
                                                ...
                                                <div class="col-md p-0 mb-2 mr-1">
                                                    <input type="text" class="form-control" name="username" placeholder="Username" required="sdgsdg">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="form-control btn btn-warning text-light mr-1" name="submit">เข้าสู่ระบบ <i class="fa fa-sign-in" aria-hidden="true"></i></button>
                                                </div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm d-flex justify-content-end">
                                            <form action="chk_all/chk_logout.php" method="post">
                                                ...
                                                <div class="row justify-content-end mt-2 pr-1 form-inline">
                                                <button class="form-control btn btn-danger text-light ml-2" type="submit" name="submit">ออกจากระบบ <i class="fa fa-sign-out" aria-hidden="true"></i></button>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" id="bg_teamSOM">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active mr-2">
                    <a class="btn btn-light mr-2 col-md font-weight-bold" href="index.php?p=home"><i class="fa fa-home text-primary" aria-hidden="true"></i> หน้าแรก<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item mr-2">
                    <a class="btn btn-light mr-2 col-md font-weight-bold" href="index.php?p=sacredOb"><i class="fa fa-archive text-warning" aria-hidden="true"></i> วัตถุมงคล</a>
                </li>
                <li class="nav-item mr-2">
                    <a class="btn btn-light mr-2 col-md font-weight-bold" href="index.php?p=newsAll"><i class="fa fa-newspaper-o text-success" aria-hidden="true"></i> ข่าวประชาสัมพันธ์</a>
                </li>
                <li class="nav-item mr-2">
                    <a class="btn btn-light mr-2 col-md font-weight-bold" href="index.php?p=aboutus"><i class="fa fa-location-arrow text-danger" aria-hidden="true"></i> เกี่ยวกับเรา</a>
                </li>
                ...
                <form action="index.php?p=home" class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="ค้นหาวัตถุมงคล" aria-label="Search">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 text-center pb-2" id="bg_ft">
                    ...
                    <a class="text-decoration-none text-light " href="https://web.facebook.com/q3.hahaha" > ติดต่อ : jirapat.m@nsru.ac.th </a>
    ...
    <script src="https://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js"></script> <!--JS Data Table-->     
